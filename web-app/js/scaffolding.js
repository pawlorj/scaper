 ...
 */
var scaffoldingModule = angular.module('scaffolding', ['ngRoute', 'grailsService', 'flashService']);
...
scaffoldingModule.config([
    ...
    function($routeProvider) {
        $routeProvider.
        	when('/stock/create', {templateUrl: '/scaper/ng-templates/stock/create.html', controller: CreateCtrl}).
            when('/stock', {templateUrl: '/scaper/ng-templates/stock/list.html', controller: ListCtrl}).
            when('/stock/:id', {templateUrl: '/scaper/ng-templates/stock/show.html', controller: ShowCtrl}).
            when('/stock/edit/:id', {templateUrl: '/scaper/ng-templates/stock/edit.html', controller: EditCtrl}).
...
scaffoldingModule.directive('alert', function() {
	...
	return {
        ...
        templateUrl: '/scaper/ng-templates/alert.html',
        replace: true
    }
});
...
scaffoldingModule.directive('pagination', function() {
	...
	return {
        ...
        templateUrl: '/scaper/ng-templates/pagination.html',
        replace: false
    }
});
...
scaffoldingModule.directive('sortable', function() {
	...
	return {
		...
		templateUrl: '/scaper/ng-templates/sortable.html',
		replace: false
	}
});
...
function ListCtrl($scope, $routeParams, $location, Grails, Flash) {
    Grails.query($routeParams, function(list, headers) {
        $scope.list = list;
...
function CreateCtrl($scope, $location, Grails, Flash) {
    ...
    $scope.save = function(item) {
        item.$save(function(response) {
            Flash.success(response.message);
            $location.path('/stock/' + response.id);
        }, errorHandler.curry($scope, $location, Flash));
    };
}
